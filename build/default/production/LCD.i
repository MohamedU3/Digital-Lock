...
void LCD_CLEAR(){
    LCD_CMD(0x00);
    LCD_CMD(0x01);
    _delay((unsigned long)((82)*(4000000/4000000.0)));
}


void LCD_DISPLAY(unsigned char state){
    LCD_CMD(0);
    if(state == 1) LCD_CMD(0x0C);
    else LCD_CMD(0x08);
    _delay((unsigned long)((37)*(4000000/4000000.0)));
}
void LCD_SHOW_CURSOR(unsigned char c){
    LCD_CMD(0);
    if(c == 1) LCD_CMD(0x0E);
    else LCD_CMD(0x0C);
    _delay((unsigned long)((37)*(4000000/4000000.0)));
...
void RETURN_HOME(){
    LCD_CMD(0);
    LCD_CMD(0x02);
    _delay((unsigned long)((1.52)*(4000000/4000.0)));
}
